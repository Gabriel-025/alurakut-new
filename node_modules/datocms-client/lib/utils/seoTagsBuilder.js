...
var builders = {
  title: function title(item, site) {
    var titleField = item && item.itemType.titleField;
  ...
  articleModifiedTime: function articleModifiedTime(item) {
    ...
    return ogTag('article:modified_time', "".concat(item.updatedAt.toISOString().split('.')[0], "Z"));
  },
  ...
  ogLocale: function ogLocale() {
    return ogTag('og:locale', "".concat(_i18n.default.locale, "_").concat(_i18n.default.locale.toUpperCase()));
  },
