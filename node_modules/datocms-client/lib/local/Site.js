...
function () {
  ...
  _createClass(Site, [{
    ...
    value: function readAttribute(attribute, TypeKlass, localized) {
      ...
      if (localized) {
        value = (0, _localizedRead.default)(this.entity[attribute] || {});
      } else {
        value = this.entity[attribute];
      }

      var imgixHost = "https://".concat(this.imgixHost);
    ...
    key: "favicon",
    get: function get() {
      return this.readAttribute('favicon', _File.default, false);
    }
  }, {
    key: "faviconMetaTags",
    get: function get() {
      return (0, _faviconTagsBuilder.default)(this);
    }
  }]);
