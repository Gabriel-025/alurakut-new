...
function () {
  ...
  _createClass(Item, [{
    ...
    value: function readAttribute(field) {
      ...
      if (localized) {
        value = (0, _localizedRead.default)(this.entity[(0, _humps.camelize)(field.apiKey)] || {});
      } else {
        value = this.entity[(0, _humps.camelize)(field.apiKey)];
      }

      return (0, _build.default)(fieldType, value, this.itemsRepo);
    }
  }, {
    key: "id",
    get: function get() {
    ...
    key: "updatedAt",
    get: function get() {
      return new _DateTime.default(Date.parse(this.entity.updatedAt));
    }
  }, {
    key: "createdAt",
    get: function get() {
      return new _DateTime.default(Date.parse(this.entity.createdAt));
    }
  }, {
    key: "parent",
    get: function get() {
    ...
    get: function get() {
      ...
      if (seoField) {
        return (0, _seoTagsBuilder.default)(this, this.itemsRepo.site);
      }
